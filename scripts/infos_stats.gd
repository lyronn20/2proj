...
@onready var lbl_ticks = $VBoxContainer/Ticks_sec

var time_elapsed := 0.0
var tick_speed := 1

func _ready():
	var color = Color.html("#e9bc96")  # couleur demandée
	...
	lbl_ticks.add_theme_color_override("font_color", color)
...
func _process(delta):
	...
	lbl_ticks.text = "%d ticks/sec" % int(60 * tick_speed)
